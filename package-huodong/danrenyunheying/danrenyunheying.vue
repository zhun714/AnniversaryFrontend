  ...
  <view class="flex-col page">
    <view class="flex-col group">
      ...
      <view class="flex-col section_4">
        <view class="flex-col items-center button" @click="changetodanren_upload()"><text class="font_1 text_5">上传人像</text></view>
      </view>
    </view>
  </view>
</template>
...
<script>
  export default {
    ...
    methods: {
		changetodanren_upload(){
			uni.navigateTo({
				url:'/package-huodong/danren_upload/danren_upload'
			})
		}
	},
  };
